...
function wxBird(opts) {
    ...
    var up_pipe = this.up_pipe = new UpPipe(ctx, 0, 0, 100, 200, "../../images/pipe2.png");
    var down_pipe = this.down_pipe = new DownPipe(ctx, 0, 400, 100, 200, "../../images/pipe2.png");
...
wxBird.prototype.calculator = function () {
    if (this.bird.by + this.bird.bheight > this.ground.bgy ||
        ...
        this.ctx.fillText("游戏结束,得分：" + this.score + "!", 90, 100)
